<template>
  <aside class="flex h-full flex-col gap-4 rounded-3xl border border-white/5 bg-slate-900/60 p-5 shadow-xl shadow-black/20">
    <header class="flex items-center justify-between">
      ...
      <button
        type="button"
        class="inline-flex items-center gap-2 rounded-full bg-indigo-500 px-3 py-1.5 text-xs font-semibold uppercase tracking-wide text-white shadow hover:bg-indigo-400"
